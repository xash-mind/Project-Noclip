...
const PROP_CATALOG: ReadonlyArray<Omit<ObjectCatalogEntry, 'id' | 'kind'>> = [
  ...
  { label: 'Wall Panel', categoryId: 'architecture', propKind: 'wall-panel', searchTerms: ['panel'] },
  { label: 'Arch Segment', categoryId: 'architecture', propKind: 'arch-segment', searchTerms: ['arch', 'curve', 'vault'] },
