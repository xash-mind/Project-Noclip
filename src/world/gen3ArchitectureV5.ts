...
/**
 * dev.5 no longer asks independent wall segments to invent rooms. Space topology
 * owns the room graph, portal degree and Region-shaped spatial hierarchy first;
 * this function only realizes that already-intentional graph as streamed geometry.
 */
