...
def main() -> None:
    ...
    try:
        report["browser"] = {
            ...
            "chromeBinary": driver.capabilities.get("chrome", {}).get("chromedriverVersion"),
        }
        ...
        try:
            ...
            report["warnings"].append("Headless Chromium did not grant pointer lock; movement verification was skipped.")

        if pointer_locked:
            ActionChains(driver).key_down("w").pause(0.9).key_up("w").perform()
            time.sleep(2.2)
